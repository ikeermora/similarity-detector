...
; Modified for 8-bit XNOR similarity detector layout
...
; CHANGE THIS if your final core cell is not named mips8
core core
...
place pad_dgnd
place pad_dvdd
place pad_dgnd gnd=gnd export pad=GND
place pad_dvdd vdd=vdd export pad=VDD